      ...
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-12">
          ...
          <p className="text-md text-white/80 max-w-2xl mx-auto mb-8">
            My mission is to empower businesses and startups by delivering robust user-centric web solutions. Have a project 
        ...
        <div className="flex justify-center gap-6 mt-12">
          <Link
            href="https://www.instagram.com/shivansh07.__/"
            target="_blank"
